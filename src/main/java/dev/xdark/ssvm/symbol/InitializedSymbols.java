 ...
 * @author xDark
 */
public final class InitializedSymbols implements Symbols {
	...
	private final InstanceClass reflect_ReflectionFactory;
	...
	private final InstanceClass java_lang_invoke_ResolvedMethodName;
	...
	private final InstanceClass perf_Perf;
	...
	private final InstanceClass reflect_ConstantPool;
	...
	private final InstanceClass internal_reflect_Reflection;
	 ...
	 */
	public InitializedSymbols(VirtualMachine vm) {
		...
		InstanceClass reflectionFactory = (InstanceClass) vm.findBootstrapClass("jdk/internal/reflect/ReflectionFactory");
		if (reflectionFactory == null) {
			reflectionFactory = (InstanceClass) vm.findBootstrapClass("sun/reflect/ReflectionFactory");
		}
		...
		InstanceClass perf_Perf = (InstanceClass) vm.findBootstrapClass("jdk/internal/perf/Perf");
		if (perf_Perf == null) {
			perf_Perf = (InstanceClass) vm.findBootstrapClass("sun/misc/Perf");
		}
		...
		InstanceClass reflect_ConstantPool = (InstanceClass) vm.findBootstrapClass("jdk/internal/reflect/ConstantPool");
		if (reflect_ConstantPool == null) {
			reflect_ConstantPool = (InstanceClass) vm.findBootstrapClass("sun/reflect/ConstantPool");
		}
		...
		InstanceClass reflect_MethodAccessorImpl = (InstanceClass) vm.findBootstrapClass("jdk/internal/reflect/MethodAccessorImpl");
		if (reflect_MethodAccessorImpl == null) {
			reflect_MethodAccessorImpl = (InstanceClass) vm.findBootstrapClass("sun/reflect/MethodAccessorImpl");
		}
		...
		java_lang_Module = (InstanceClass) vm.findBootstrapClass("java/lang/Module");
		...
		InstanceClass internal_reflect_Reflection = (InstanceClass) vm.findBootstrapClass("jdk/internal/reflect/Reflection");
		if (internal_reflect_Reflection == null) {
			internal_reflect_Reflection = (InstanceClass) vm.findBootstrapClass("sun/reflect/Reflection");
			if (internal_reflect_Reflection == null) {
	...
	private static InstanceClass resolvedMemberName(VirtualMachine vm) {
		InstanceClass jc = (InstanceClass) vm.findBootstrapClass("java/lang/invoke/ResolvedMethodName");
		if (jc == null) {
